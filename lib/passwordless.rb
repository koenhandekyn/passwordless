...
require "passwordless/tiny_token_generator"
...
module Passwordless
  ...
  mattr_accessor(:tiny_token_generator) { TinyTokenGenerator.new }
  ...
  mattr_accessor(:tiny_token_timeout_at) { lambda { 3.minutes.from_now } }
